...
* You are never timed on holstering your firearm and holstering frequently when people have accidents. Take your time holstering your firearm, look at the holster, make sure your shirt or sweater isn't in the way. Make sure your finger is off the trigger and along the side of the firearm.

* Breaking the safety muzzle points. Each stage has either muzzle safety cones or an imaginary 180 degree line. Sometimes while reloading or moving you might twist the gun. If you move the muzzle past the limits you will be disqualified. 
...
* **Standby**
  * You should remain still in the start position, waiting the buzzer from the timer. 
* **BEEP**
  ...
  * While shooting you may here the following three commands.
* **Muzzle, Finger, Stop**
...
* **Range is Clear**
  * It is now safe to go downrange and score the targets, tape them and reset the stage for the next shooter.
...
* Bob shoots the stage in 30 seconds. The shot timer records each shot taken so the end time is the time of your last shot. Scoring the targets Bob realizes he missed two shots on the paper targets. His final time will be 35 seconds (2.5 seconds for each missed paper shot).
...
Weather in Utah can be unpredictable. You should be prepared to spend 8+ hours outside during a match. In the summer we recommend 1 gallon of water per person, sunscreen and a hat. During the winter you will need boots, jackets, gloves and a hat. If it rains a full set of raingear is very handy, especially if it's cold. We very almost never cancel a match due to the weather.


## UDPL Handgun Matches

These include the Super Shoot, Steel Challenge, Man vs Man, ICORE and other variants. These matches are open to all with no additional membership needed to shoot the match.
...
IDPA requires an additional IDPA membership. You can sign up online. IDPA also has more rules and focuses specifically on defensive shooting scenarios you might encounter while concealed carrying a firearm.
